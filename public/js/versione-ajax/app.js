...
$(document).ready(function () {
  ...
  var template_function = Handlebars.compile(template_html); //effettuo la chiamata ajax per recuperare i dischi
  ...
  function gestione_dati(lista_dischi) {
    ...
    for (var i = 0; i < lista_dischi.length; i++) {
      ...
      var disco = lista_dischi[i]; //preparo l'oggetto di handlebars
